...
# -*- coding: utf-8 -*-
#
# scikit-surgeryutils documentation build configuration file, created by
...
# This allows modules to be indexed under the submodule name rather than all appearing under sksurgeryutils
...
# The full version, including alpha/beta/rc tags.
# release = sksurgeryutils.__version__
...
htmlhelp_basename = 'scikit-surgeryutilsdoc'
...
latex_documents = [
    ('index', 'scikit-surgeryutils.tex',
     u'scikit-surgeryutils Documentation',
